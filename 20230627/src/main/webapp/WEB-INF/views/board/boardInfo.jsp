...
<table class="table">
	<h2> 회원 상세정보 </h2>
	<tr>
		<th>아이디</th><td class="uid">${member.userId }</td>
	</tr>
	<tr>
		<th>암호</th><td><input type="text" class="passwd" value="${member.userPw }"></td>
	</tr>
	<tr>
		<th>이름</th><td><input type="text" class="name" value="${member.userName }"></td>
	</tr>
	<tr>
		<th>연락처</th><td><input type="text" class="phone" value="${member.userPhone }"></td>
	</tr>
	<tr>
		<th>주소</th><td><input type="text" class="addr" value="${member.userAddr }"></td>
	</tr>
	<tr>
		<th>생년월일</th><td><fmt:formatDate pattern="yyyy-MM-dd" value="${member.userBirth }"/></td>
	</tr>
	<tr>
		<th>대표이미지</th>
		<td>
		<img class="image" width = "190px" src="images/${member.userImg }">
